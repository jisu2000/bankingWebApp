...
<body
    ...
    <div class="container text-center">
        <h1 style="color: black;">Account details</h1>
    </div>
    ...
    <div class="box-wrapper">
        <div class="box">
            ...
            <h3 class="box-content" style="font-family: 'Times New Roman', Times, serif;"><%=user.getUserName() %> </h3>
        </div>
        <div class="box">
            <span class="box-header">User Id</span>
            <h3 class="box-content" style="font-family: 'Times New Roman', Times, serif;"><%=user.getUserId() %> </h3>
        </div>
        <div class="box">
            <span class="box-header">Email Id</span>
            <h3 class="box-content" style="font-family: 'Times New Roman', Times, serif;"><%=user.getUserEmail() %> </h3>
        </div>
        <div class="box">
            <span class="box-header">Contact No</span>
            <h3 class="box-content" style="font-family: 'Times New Roman', Times, serif;"><%=user.getCont() %></h3>
        </div>
        <div class="box special">
            <span class="box-header">Address </span>
            <h3 class="box-content" style="font-family: 'Times New Roman', Times, serif;"><%=user.getUserAddress() %> </h3>
        </div>

        <div class="box">
            <span class="box-header">Opening Date</span>
            <h3 class="box-content" style="font-family: 'Times New Roman', Times, serif;"><%=user.getOpenedDate()%> </h3>
        </div>
        <div class="box">
            <span class="box-header">Account Number</span>
            <h3 class="box-content" style="font-family: 'Times New Roman', Times, serif;"> <%=user.getAccNo() %></h3>
        </div>
