...
<body
	...
	<div class="box-wrapper">
		<div class="box">
			...
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=emp.getEmpName()%>
			</h3>
		</div>
		<div class="box">
			<span class="box-header">Employee Id</span>
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=emp.getEmpId()%></h3>
		</div>
		<div class="box">
			<span class="box-header">Email Id</span>
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=emp.getEmpEmail()%>
			</h3>
		</div>
		<div class="box">
			<span class="box-header">Contact No</span>
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=emp.getEmpCont()%></h3>
		</div>
		<div class="box special">
			<span class="box-header">Address </span>
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=emp.getEmpAdd()%></h3>
		</div>

		<div class="box">
			<span class="box-header">Joining Date</span>
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=emp.getJoinedDate()%>
			</h3>
		</div>
		<div class="box">
			<span class="box-header">Salary</span>
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=emp.getEmpsal()%>/-
			</h3>
		</div>
	...
	<div class="container text-center">
		<a href="empup/<%=emp.getEmpId()%>"
			class="btn btn-outline-success btn-lg">Update</a>
	</div>
</body>
