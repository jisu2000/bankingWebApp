...
<body
	...
	<div class="box-wrapper">
		...
		<div class="box">
			...
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=user.getAccNo() %>
			</h3>
		</div>
		<div class="box">
		...
		<div class="box special">
			...
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;"><%=user.getUserAddress() %>
			</h3>
		</div>
		...
		<div class="box">
			<span class="box-header">IFSC</span>
			<h3 class="box-content"
				style="font-family: 'Times New Roman', Times, serif;">
				<%=user.getIfSc() %>
			</h3>
